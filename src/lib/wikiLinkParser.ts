 ...
 * @returns 解析结果
 */
export function parseInternalLink(input: string): { slug: string; displayText: string } | null {
 ...
 * @returns 提取的元数据
 */
export function extractMetadataFromMarkdown(content: string, slug: string): WikiPageMetadata {
