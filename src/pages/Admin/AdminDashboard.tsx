            ...
            return (
              ...
              >
                <div className="flex items-center gap-2 mb-3">
                  <Icon
                    size={16}
                    className="text-text-muted group-hover:text-brand-gold transition-colors"
                  />
                  <span className="text-sm text-text-muted group-hover:text-brand-gold transition-colors">
                    {c.label}
                  </span>
                </div>
