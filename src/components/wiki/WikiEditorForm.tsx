...
const WikiEditorForm = React.memo(({ formData, onFormDataChange }: WikiEditorFormProps) => {
  ...
  return (
    <>
      ...
      <div className="space-y-2">
        ...
        <div id="wiki-content" className="border border-border rounded overflow-hidden bg-surface">
          <MarkdownEditor
      ...
      <div className="space-y-2">
        <label className="text-xs font-bold uppercase tracking-widest text-text-muted">地点</label>
        <LocationTagInput
